...
#ifndef MyAppVer
#define MyAppVer "0.10.6"
#endif
#ifndef VerInfoVersion
#define VerInfoVersion "0.10.6.0"
#endif
#ifndef MyArch
#define MyArch "x64"
#endif
...
; 简体中文语言文件：Inno Setup 官方安装包**不附带**中文（该翻译属 Unofficial，只在官方源码仓库里发布），
; 因此打包脚本会准备好文件并通过 /DLangFile=<绝对路径> 注入（本机装了中文就用本机的，否则自动下载）。
; 直接用 ISCC 编译本脚本（不经脚本）时，退回用编译器目录下的同名文件。
#ifndef LangFile
