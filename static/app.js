...
const CHANGELOG = [
  ...
  },
  {
    ...
    items: [
      '<b>打印 / 导出的 PDF 单据里，单元格内容写不下时自动换行</b>：以前长名称、长规格、长序列号会被截断并显示省略号（…），现在会完整换行显示，行高自动撑开，内容再多也不会被切断',
      '修复<b>覆盖升级安装后后台服务没有自动起来</b>的问题：以前升级安装完成后往往要手动重启服务才能打开面板，现在安装结束会自动把服务重新注册并启动',
    ],
  },
  {
